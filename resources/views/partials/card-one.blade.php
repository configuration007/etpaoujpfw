<div class="slide-content">
    <div class="chaLIY">
        <div class="TDzzN">
            <svg width="137" height="32" fill="none">
                ...
                <path
                    ...
                    fill="#fff" stroke="#7349f2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
                <path
        ...
        <h2 class="krxgxg iQLqHO">
            {{ $head_text }}
        </h2>
        <div class="hKyvsg">
            <div class="dtLnoK">
                <img src="{{ $image_url }}" alt="" class="kQrdDU active" width="{{ $image_width }}" height="{{ $image_height }}">
            </div>
        </div>
        <h3 class="krxgxgx">
            {{ $mid_text }}
