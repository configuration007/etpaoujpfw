    ...
    <div class="elahoN">
        ...
        <div class="jBpENL">
            <div class="hWPHrf">
                ...
                <div class="abSAas jYTJyU" @click="$store.dispatch('recieveBitcoin', true)">
                    Recieve
                </div>
            </div>
        </div>
        ...
        <div class="resdUS">
            <form class="gCdspF" v-if="is_processing" @submit.prevent="initiateTransaction">
                <div class="cdsdASDC">
                    <label>Address</label>
                    <div class="sDEad">
                        <input class="gqlmIw" type="text" v-model="payload.address" required />
                    </div>
                </div>
                <div class="sadsdA">
                    <div class="csAXs">
                ...
                <div class="cdsdASDC">
                    ...
                    <div class="sDEad">
                        <input class="gqlmIw" type="text" v-model="payload.description" required />
                    </div>
                </div>
                <div class="sadsdA saAsaw">
                    <span class="sAsasq">There is a {{ btc_balance }} BTC free for this
                        wallet</span>
