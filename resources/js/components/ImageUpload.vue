...
<div class="dropzone">
    ...
    <div class="layer layer_2" v-if="!uploaded">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-up-circle" width="56" height="56" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ccc" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="cancel_photo" v-if="uploaded" @click="resetPhoto">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="44" height="44" viewBox="0 0 24 24" stroke-width="1" stroke="red" fill="red" stroke-linecap="round" stroke-linejoin="round">
